...
# --- config ---
csv_path = '../data/structure.csv.gz'
output_video = '../assets/structure_growth_preview.mp4'
layer_to_plot = 5
...
writer = animation.FFMpegWriter(fps=5, metadata=dict(artist='RipPost'), bitrate=1800)
